...
{ image: "images/MapReduceImageTalend.jpg", class: 'OS', alt: "MapReduce Image", title: 'MapReduce', descr: 'Partner Project for CS 537. Implemented the MapReduce programming model in C to calculate the word counts of 10mb of data in less than a second. Incorporated a Combiner function. Revised project individually to account for unused partitions.', date: 'May 2020<br>Repo Available upon Request*', link: 'http://pages.cs.wisc.edu/~shivaram/cs537-sp20/p4a.html', button: 'Project Description'},
...
{ image: "images/RectangleTerminal3.png", class: 'OS', alt: "Terminal Application Image", title: 'Unix Shell', descr: 'CS537 Simplified Unix Shell with select build in commands like cd and path. Written in C.', date: 'February 2020<br>Repo Available upon Request*', link: 'http://pages.cs.wisc.edu/~shivaram/cs537-sp20/p2a.html', button: 'Project Description'},
...
{ image: "images/memlayout2.png", class: 'other', alt: "Memory Layout Image", title: 'Dynamic Memory Allocator', descr: 'CS354 Dynamic Memory Allocator. Emulated the C malloc() and free() library functions with an implicit free list and the Next-Fit Placement Policy.', date: 'Fall 2019<br>Repo Available upon Request*'},
];
