...
$.each(cardData, function (i) {
        ...
        animation = "none";
        var templateString = '<div><div class= "mx-4 mb-4 card proj ' + cardData[i].class + ' " data-aos=' + animation + ' style = "height: 97%" ><img src=' + cardData[i].image + ' height = "250px" width = "300px" class="card-img-top" alt=' + cardData[i].alt + '><div class="card-body shadow"><h4 class="card-title" style = "font-size: 2vh">' + cardData[i].title + '</h4>'+
