...
$(document).ready(function(){
    ...
    // 
var cardData = [
    { image: "images/Scheduler_Cart.png", alt: "Course Scheduler Image", title: 'University Course Search Web App', descr: 'Developed a university course web application with ReactJS. Implemented the UI with a multi-level, pan & zoom navigation model and conducted usability design with heuristic evaluation. Features include search filtering, ratings and recommendations, prerequisite checks, and more.', date: 'Oct 2020', link: '#', button: 'Coming Soon'},
{ image: "images/chat.png", alt: "Chat Image", title: 'Socket.IO Chat Web App', descr: 'Chat application written with Node.js, Express, and MongoDB. Features include persistent message storage, private and general chat rooms, and online/offline statuses.', date: 'July 2020', link: 'https://github.com/tituscsmith/socket-chat', button: 'Project Code'},
{ image: "images/library.png", alt: "Book Image", title: 'Library Management Web App', descr: 'Implemented a library web application with MySQL and PHP. Features include search filtering, check-out/check-in system, user-control access, and additional admin privileges.', date: 'June 2020', link: 'https://github.com/tituscsmith/library', button: 'Project Code'},
...
{ image: "images/covid.jpg", alt: "COVID-19 Image", title: 'COVID-19 Data Visualizer', descr: 'Pulled and visually represented COVID-19 Data with Google Charts and API Calls to the COVID Tracking Project. Able to view state and national data.', date: 'May 2020', link: 'https://tituscsmith.github.io/covid-19/visualizer.html', button: 'See Visualizer'},
