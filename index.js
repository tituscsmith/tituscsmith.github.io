...
var cardData = [
  { image: "images/Mumbler.png", class: 'web', alt: "Mumbler Brand Logo", title: 'Mumbler Social Media App', descr: 'A social media app developed with React, Redux, and Firebase Firestore. Users are able to post, view, comment on, and react to posts (mumbles). Additionally, app supports comment notifications, the ability to follow users, upload profile pictures, filter swear words, message limits and admin privileges. Makes use of Firebase Authentication, Functions, and Storage. Personal Project.', date: 'Jan 2021', link: 'https://mumbler-fa910.web.app/', button: 'Web App!'},
...
$.each(cardData, function (i) {
        ...
        animation = "none";
        var templateString = '<div><div class= "mx-4 mb-4 card proj ' + cardData[i].class + ' " data-aos=' + animation + '" ><img src=' + cardData[i].image + ' height = "250px" width = "300px" class="card-img-top" alt=' + cardData[i].alt + '><div class="card-body shadow"><h4 class="card-title" style = "font-size: 2vh">' + cardData[i].title + '</h4>'+
