...
var cardData = [
  { image: "images/Mumbler.png", class: 'web', alt: "Mumbler Brand Logo", title: 'Mumbler Social Media App', descr: 'A social media app with React, Redux, and Firebase Firestore. Users are able to post, view, comment on, and react to posts (mumbles). Additionally, supports the ability to follow/filter users and upload profile pictures. Makes use of Firebase Authentication, Functions, and Storage. Personal Project.', date: 'Jan 2021', link: 'https://mumbler-fa910.web.app/', button: 'Web App!'},
