...
var cardData = [
  { image: "images/Mumbler.png", class: 'web', alt: "Mumbler Brand Logo", title: 'Mumbler Social Media App', descr: 'Developed with React, Redux, and Firebase. Users are able to post, view, comment on, and react to posts. Additionally, app supports comment notifications, profile pictures, profanity filtering, character/post limits, user following, and various admin privileges. Makes use of Firestore, Auth, Functions, and Storage. Personal Project.', date: 'Jan 2021', link: 'https://mumbler-fa910.web.app/', button: 'Web App!'},
  { image: "images/shoppingassistant.jpeg", class: 'other', alt: "Dialogflow Agent Image", title: 'Dialogflow Shopping Assistant', descr: 'A dialogue-based interface that assists users of an online fictional store. App works with an existing web app and API. Agent includes support for users with cart and inventory queries, item filtering, web app navigation, and purchasing items. Implemented the Dialogflow webhook with  Javascript.', date: 'Dec 2020', link: 'https://github.com/tituscsmith/WiscShopDialogflow', button: 'Project Repo'}, 
  { image: "images/CCTall.png", class: 'mobile', alt: "Calorie Crusher Image", title: 'Calorie Crusher Mobile App', descr: 'A fitness and meal tracking mobile app created with React Native in tangent with an existing RESTful API. Users are able to set nutrition and activity goals, log meals and activity sessions, and track daily progress to goals. Integrated accessibility features to support screen reader use on iOS.', date: 'Nov 2020', link: 'https://github.com/tituscsmith/calorie_crusher', button: 'Project Repo'},
...
{ image: "images/moviedatabase.png", class: 'web', alt: "Movie Image", title: 'Movie Database Web App', descr: 'An IMDB-like web application developered with MySQL and PHP. Collaborative implemented in a 3 Person Academic Project. Refined the schema to 3NF. Features include user-control access, search filtering, a rating system, and additional admin privileges. Implementation includes queries and stored procedures.', date: 'July 2020', link: 'https://github.com/tituscsmith/moviesDB', button: 'Project Repo'},
