...
var cardData = [
  { image: "images/Mumbler.png", class: 'web', alt: "Mumbler Brand Logo", title: 'Mumbler Social Media App', descr: 'A social media app developed with React Redux, and Firebase Firestore. Users are able to post (mumble), view, and react to mumbles as well as follow users. Makes use of user authentication and a cloud function.', date: 'Jan 2021', link: 'https://mumbler-fa910.web.app/', button: 'Web App'},
