...
var cardData = [
  { image: "images/Mumbler.png", class: 'web', alt: "Mumbler Brand Logo", title: 'Mumbler Social Media App', descr: 'A social media app developed with React, Redux, and Firebase Firestore. Users are able to post, view, comment on, and react to posts (mumbles). Additionally, app supports comment notifications, profile pictures, swear word filtering, message limits, user following, and various admin privileges. Makes use of Firebase Authentication, Functions, and Storage. Personal Project.', date: 'Jan 2021', link: 'https://mumbler-fa910.web.app/', button: 'Web App!'},
  { image: "images/shoppingassistant.jpeg", class: 'other', alt: "Dialogflow Agent Image", title: 'Dialogflow Shopping Assistant', descr: 'A dialogue-based interface that assists users of an online fictional store that works in tangent with an existing web app and API. Agent includes support for users with cart and inventory queries, item filtering, navigating the pages of the web app, and purchasing items. Implemented the Dialogflow Webhook with Javascript.', date: 'Dec 2020', link: 'https://github.com/tituscsmith/WiscShopDialogflow', button: 'Project Repo'}, 
...
$.each(cardData, function (i) {
        ...
        animation = "none";
        var templateString = '<div style = "max-width: 450px !important" class= "mx-2 mb-4 card proj ' + cardData[i].class + ' " data-aos=' + animation + '" ><img src=' + cardData[i].image + ' height = "250px" width = "300px" class="card-img-top" alt=' + cardData[i].alt + '><div class="card-body shadow"><h4 class="card-title" style = "font-size: 2vh">' + cardData[i].title + '</h4>'+
